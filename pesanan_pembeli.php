...
?>
  ...
  if (empty($_SESSION["pesanan"]) or !isset($_SESSION["pesanan"])) {
    ...
    echo "<script>location= 'barang_pembeli.php'</script>";
  }
  ?>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="barang_pembeli.php">DAFTAR MENU</a>
            </li>
            <li class="nav-item">
    ...
    <div class="container">
      ...
      <form method="POST" action="">
        <a href="barang_pembeli.php" class="btn btn-primary btn-sm">Lihat Menu</a>
      ...
      if (isset($_POST['konfirm'])) {
        ...
        foreach ($_SESSION["pesanan"] as $id_barang => $jumlah) {
          $insert = mysqli_query($koneksi, "INSERT INTO pemesanan_produk (id_pemesanan, id_barang, jumlah) 
              VALUES ('$id_terbaru', '$id_barang', '$jumlah') ");
        }
